...
% Initial safety and human confirmation facts
...
% Known initial facts for printing
...
fact_description(safe_to_lift_beam):-
    nb_getval(fileOutput,Out),
    write(Out,'The action is safe because both robot and human confirm it.'),
    write('The action is safe because both robot and human confirm it.').
